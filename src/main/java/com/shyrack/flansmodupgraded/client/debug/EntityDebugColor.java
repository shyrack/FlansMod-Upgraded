package com.shyrack.flansmodupgraded.client.debug;
...
public abstract class EntityDebugColor extends Entity {
    ...
    private static final DataParameter<Float> COLOR_RED = EntityDataManager.createKey(EntityDebugVector.class, EntityDataSerializers.FLOAT);
    private static final DataParameter<Float> COLOR_GREEN = EntityDataManager.createKey(EntityDebugVector.class, EntityDataSerializers.FLOAT);
    private static final DataParameter<Float> COLOR_BLUE = EntityDataManager.createKey(EntityDebugVector.class, EntityDataSerializers.FLOAT);
