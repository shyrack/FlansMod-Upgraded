...
import com.shyrack.flansmodupgraded.common.guns.EntityDamageSourceFlan;
...
public class FlansModExplosion extends Explosion {
    ...
    public void doExplosionB(boolean spawnParticles) {
        ...
        if (this.size >= 2.0F && this.breaksBlocks) {
            this.world.spawnParticle(ParticleTypes.EXPLOSION, this.x, this.y, this.z, 1.0D, 0.0D, 0.0D);
        } else {
            this.world.spawnParticle(ParticleTypes.EXPLOSION, this.x, this.y, this.z, 1.0D, 0.0D, 0.0D);
        }
