...
import net.minecraft.world.phys.Vec;
...
public class ItemPlane extends Item implements IPaintableItem {
    ...
    public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer entityplayer, EnumHand hand) {
        ...
        double length = 5D;
        Vec posVec = new Vec(entityplayer.posX, entityplayer.posY + 1.62D - entityplayer.getYOffset(), entityplayer.posZ);
        Vec lookVec = posVec.add(sinYaw * cosPitch * length, sinPitch * length, cosYaw * cosPitch * length);
        ...
        if (RayTraceResult.typeOfHit == Type.BLOCK) {
            ...
            if (type.placeableOnLand || block instanceof LiquidBlock) {
                if (!world.isRemote) {
