...
public class ModelExoskeletonHelmet extends ModelCustomArmour
{
	public ModelExoskeletonHelmet()
	{
		...
		headModel[1] = new ModelRendererTurbo(null, 129, 1, textureX, textureY); // Box 6
		headModel[2] = new ModelRendererTurbo(null, 233, 1, textureX, textureY); // Box 7
		headModel[3] = new ModelRendererTurbo(null, 345, 9, textureX, textureY); // Box 8
		headModel[4] = new ModelRendererTurbo(null, 1, 41, textureX, textureY); // Box 9
		headModel[5] = new ModelRendererTurbo(null, 1, 1, textureX, textureY); // Box 10
		headModel[6] = new ModelRendererTurbo(null, 17, 1, textureX, textureY); // Box 11
		headModel[7] = new ModelRendererTurbo(null, 345, 1, textureX, textureY); // Box 12
		headModel[8] = new ModelRendererTurbo(null, 97, 1, textureX, textureY); // Box 14
		headModel[9] = new ModelRendererTurbo(null, 129, 1, textureX, textureY); // Box 15
