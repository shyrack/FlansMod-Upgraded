...
public class ModelExoskeletonBoots extends ModelCustomArmour
{
	public ModelExoskeletonBoots()
	{
		...
		rightLegModel[0] = new ModelRendererTurbo(null, 313, 113, textureX, textureY); // Box 100
		rightLegModel[1] = new ModelRendererTurbo(null, 57, 121, textureX, textureY); // Box 102
		rightLegModel[2] = new ModelRendererTurbo(null, 217, 121, textureX, textureY); // Box 104
		...
		leftLegModel[0] = new ModelRendererTurbo(null, 1, 121, textureX, textureY); // Box 101
		leftLegModel[1] = new ModelRendererTurbo(null, 105, 121, textureX, textureY); // Box 103
		leftLegModel[2] = new ModelRendererTurbo(null, 409, 121, textureX, textureY); // Box 105
