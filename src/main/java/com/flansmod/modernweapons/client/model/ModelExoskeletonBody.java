...
public class ModelExoskeletonBody extends ModelCustomArmour
{
	...
	public ModelExoskeletonBody()
	{
		...
		bodyModel[0] = new ModelRendererTurbo(null, 145, 41, textureX, textureY); // Box 17
		bodyModel[1] = new ModelRendererTurbo(null, 233, 1, textureX, textureY); // Box 18
		bodyModel[2] = new ModelRendererTurbo(null, 249, 1, textureX, textureY); // Box 19
		bodyModel[3] = new ModelRendererTurbo(null, 217, 49, textureX, textureY); // Box 20
		bodyModel[4] = new ModelRendererTurbo(null, 457, 1, textureX, textureY); // Box 21
		bodyModel[5] = new ModelRendererTurbo(null, 481, 1, textureX, textureY); // Box 22
		bodyModel[6] = new ModelRendererTurbo(null, 345, 9, textureX, textureY); // Box 23
		bodyModel[7] = new ModelRendererTurbo(null, 97, 17, textureX, textureY); // Box 24
		bodyModel[8] = new ModelRendererTurbo(null, 289, 49, textureX, textureY); // Box 25
		bodyModel[9] = new ModelRendererTurbo(null, 433, 49, textureX, textureY); // Box 36
		bodyModel[10] = new ModelRendererTurbo(null, 497, 41, textureX, textureY); // Box 37
		bodyModel[11] = new ModelRendererTurbo(null, 481, 49, textureX, textureY); // Box 38
		bodyModel[12] = new ModelRendererTurbo(null, 289, 65, textureX, textureY); // Box 39
		bodyModel[13] = new ModelRendererTurbo(null, 305, 65, textureX, textureY); // Box 40
		bodyModel[14] = new ModelRendererTurbo(null, 321, 65, textureX, textureY); // Box 41
		bodyModel[15] = new ModelRendererTurbo(null, 121, 17, textureX, textureY); // Box 42
		bodyModel[16] = new ModelRendererTurbo(null, 369, 9, textureX, textureY); // Box 43
		bodyModel[17] = new ModelRendererTurbo(null, 145, 17, textureX, textureY); // Box 44
		bodyModel[18] = new ModelRendererTurbo(null, 233, 17, textureX, textureY); // Box 45
		bodyModel[19] = new ModelRendererTurbo(null, 433, 65, textureX, textureY); // Box 46
		bodyModel[20] = new ModelRendererTurbo(null, 249, 17, textureX, textureY); // Box 67
		bodyModel[21] = new ModelRendererTurbo(null, 337, 73, textureX, textureY); // Box 68
		bodyModel[22] = new ModelRendererTurbo(null, 1, 81, textureX, textureY); // Box 72
		bodyModel[23] = new ModelRendererTurbo(null, 457, 17, textureX, textureY); // Box 73
		bodyModel[24] = new ModelRendererTurbo(null, 345, 25, textureX, textureY); // Box 74
		bodyModel[25] = new ModelRendererTurbo(null, 73, 81, textureX, textureY); // Box 75
		bodyModel[26] = new ModelRendererTurbo(null, 121, 81, textureX, textureY); // Box 76
		bodyModel[27] = new ModelRendererTurbo(null, 257, 73, textureX, textureY); // Box 80
		bodyModel[28] = new ModelRendererTurbo(null, 73, 81, textureX, textureY); // Box 81
		bodyModel[29] = new ModelRendererTurbo(null, 105, 81, textureX, textureY); // Box 61
		bodyModel[30] = new ModelRendererTurbo(null, 433, 81, textureX, textureY); // Box 62
		bodyModel[31] = new ModelRendererTurbo(null, 273, 121, textureX, textureY); // Box 109
		bodyModel[32] = new ModelRendererTurbo(null, 193, 129, textureX, textureY); // Box 110
		...
		rightArmModel[0] = new ModelRendererTurbo(null, 457, 17, textureX, textureY); // Box 26
		rightArmModel[1] = new ModelRendererTurbo(null, 505, 1, textureX, textureY); // Box 28
		rightArmModel[2] = new ModelRendererTurbo(null, 97, 1, textureX, textureY); // Box 31
		rightArmModel[3] = new ModelRendererTurbo(null, 409, 49, textureX, textureY); // Box 34
		rightArmModel[4] = new ModelRendererTurbo(null, 489, 17, textureX, textureY); // Box 35
		rightArmModel[5] = new ModelRendererTurbo(null, 201, 73, textureX, textureY); // Box 63
		rightArmModel[6] = new ModelRendererTurbo(null, 113, 41, textureX, textureY); // Box 78
		rightArmModel[7] = new ModelRendererTurbo(null, 137, 129, textureX, textureY); // Box 106
		rightArmModel[8] = new ModelRendererTurbo(null, 1, 121, textureX, textureY); // Box 114
		rightArmModel[9] = new ModelRendererTurbo(null, 481, 17, textureX, textureY); // Box 119
		rightArmModel[10] = new ModelRendererTurbo(null, 153, 1, textureX, textureY); // Box 120
		rightArmModel[11] = new ModelRendererTurbo(null, 137, 49, textureX, textureY); // Box 121
		rightArmModel[12] = new ModelRendererTurbo(null, 25, 25, textureX, textureY); // Box 122
		...
		leftArmModel[0] = new ModelRendererTurbo(null, 337, 49, textureX, textureY); // Box 27
		leftArmModel[1] = new ModelRendererTurbo(null, 385, 73, textureX, textureY); // Box 71
		leftArmModel[2] = new ModelRendererTurbo(null, 1, 41, textureX, textureY); // Box 77
		leftArmModel[3] = new ModelRendererTurbo(null, 169, 81, textureX, textureY); // Box 79
		leftArmModel[4] = new ModelRendererTurbo(null, 57, 137, textureX, textureY); // Box 107
		leftArmModel[5] = new ModelRendererTurbo(null, 113, 137, textureX, textureY); // Box 115
		leftArmModel[6] = new ModelRendererTurbo(null, 113, 41, textureX, textureY); // Box 123
		leftArmModel[7] = new ModelRendererTurbo(null, 473, 65, textureX, textureY); // Box 124
		leftArmModel[8] = new ModelRendererTurbo(null, 281, 73, textureX, textureY); // Box 125
		leftArmModel[9] = new ModelRendererTurbo(null, 473, 137, textureX, textureY); // Box 126
		leftArmModel[10] = new ModelRendererTurbo(null, 473, 73, textureX, textureY); // Box 127
		leftArmModel[11] = new ModelRendererTurbo(null, 489, 89, textureX, textureY); // Box 128
		leftArmModel[12] = new ModelRendererTurbo(null, 401, 113, textureX, textureY); // Box 129
