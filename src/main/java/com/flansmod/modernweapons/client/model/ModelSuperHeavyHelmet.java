...
public class ModelSuperHeavyHelmet extends ModelCustomArmour
{
	public ModelSuperHeavyHelmet()
	{
		...
		headModel[0] = new ModelRendererTurbo(null, 28, 20, textureX, textureY);
		headModel[0].addBox(-4.5F, -9F, -4.5F, 9, 9, 9);
		
		headModel[1] = new ModelRendererTurbo(null, 20, 38, textureX, textureY);
		headModel[1].addBox(-3F, -10F, -3F, 6, 1, 6);
		
		headModel[2] = new ModelRendererTurbo(null, 38, 38, textureX, textureY);
		headModel[2].addBox(-2F, -11F, -2F, 4, 1, 4);
		
		//Side panels
		headModel[3] = new ModelRendererTurbo(null, 20, 45, textureX, textureY);
		...
		headModel[4] = new ModelRendererTurbo(null, 40, 45, textureX, textureY);
		...
		headModel[5] = new ModelRendererTurbo(null, 64, 0, textureX, textureY);
		...
		//Faceplate
		headModel[6] = new ModelRendererTurbo(null, 64, 8, textureX, textureY);
		...
		headModel[7] = new ModelRendererTurbo(null, 65, 17, textureX, textureY);
		headModel[7].addBox(-3F, 0F, -5.5F, 6, 1, 1);
		
		headModel[8] = new ModelRendererTurbo(null, 66, 19, textureX, textureY);
		headModel[8].addBox(-2F, 1F, -5.5F, 4, 1, 1);
		
		headModel[9] = new ModelRendererTurbo(null, 65, 17, textureX, textureY);
