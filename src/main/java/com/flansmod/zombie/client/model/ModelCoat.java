...
public class ModelCoat extends ModelCustomArmour
{
	public ModelCoat()
	{
		...
		skirtRearModel[0] = new ModelRendererTurbo(null, 0, 19, textureX, textureY);
		skirtRearModel[0].addBox(-5F, 0F, -3F, 10, 12, 6);

		leftArmModel = new ModelRendererTurbo[1];
		
		leftArmModel[0] = new ModelRendererTurbo(null, 32, 19, textureX, textureY);
		leftArmModel[0].addBox(-1.5F, -2.5F, -2.5F, 5, 13, 5);

		rightArmModel = new ModelRendererTurbo[1];
		
		rightArmModel[0] = new ModelRendererTurbo(null, 32, 41, textureX, textureY);
