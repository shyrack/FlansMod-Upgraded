...
/**
 * A vertex with position and texture coordinates. Standalone replacement for
 * the old Minecraft {@code net.minecraft.client.model.PositionTextureVertex}.
 */
public class PositionTextureVertex
{
	...
	{
		this(par1PositionTextureVertex.vector3D, par2, par3);
